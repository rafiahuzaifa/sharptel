              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r from-red-600 to-red-500 text-white px-6 py-2 rounded-full font-bold">
                      Most Popular
                    </div>
                  </div>
                )}
                
                <div className={`bg-gradient-to-b from-white to-gray-50 rounded-3xl shadow-xl overflow-hidden border ${
                  plan.popular ? 'border-red-200' : 'border-gray-200'
                }`}>
                  <div className={`bg-gradient-to-r ${plan.color} h-3`}></div>
                  
                  <div className="p-8">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">{plan.name}</h3>
                    <div className="text-4xl font-bold text-gray-900 mb-2">{plan.speed}</div>
                    <div className="text-3xl font-bold text-gray-900 mb-6">{plan.price}<span className="text-lg text-gray-600">/month</span></div>
